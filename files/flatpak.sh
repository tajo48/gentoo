...
flatpak install --assumeyes --noninteractive --user flathub de.haeckerfelix.Fragments
...
flatpak install --assumeyes --noninteractive --user flathub com.github.fushinari.Wordbook
flatpak install --assumeyes --noninteractive --user flathub com.github.flxzt.rnote
...
#flatpak install --assumeyes --noninteractive --user flathub com.dec05eba.gpu_screen_recorder <- check out if this shit works on every gpu (no it doesn't)
#flatpak install --assumeyes --noninteractive --user flathub nl.g4d.Girens <- Plex GTK client
